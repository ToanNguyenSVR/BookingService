 ...
 * @author toann
 */
@WebServlet(name = "SearchRequestByUserServlet", urlPatterns = {"/SearchRequestByUserServlet"})
public class SearchRequestByUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<tblRequestDTO> list = requestDao.searchRequestByDate(dateSearch , email);
            if (list != null) {
                session.setAttribute("HISTORYBOOKING", list);
