 ...
 * @author toann
 */
@WebServlet(name = "SearchRequestByAdminServlet", urlPatterns = {"/SearchRequestByAdminServlet"})
public class SearchRequestByAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<tblRequestDTO> list = requestDao.searchRequestByDate(dateSearch);
            if (list != null) {
